...
declare module 'react-vis-force' {
    ...
    export class ForceGraphNode extends React.Component<IForceGraphNodeProps, {}>{}
    ...
    export class ForceGraphLink extends React.Component<IForceGraphLinkProps, {}>{}
    ...
    class InteractiveForceGraph extends React.Component<IForceGraphProps & InteractiveForceGraphProps, {}>{}
}